 	...
 	function clear_interval()
  	{
    	s=0;
		clearInterval(trigger);
      	document.getElementById("timeout").innerHTML="<b>Duration:</b> "+s;
    }
	function suggest(q)
	{
	...
	<form onsubmit="return false;">
		<table class="frm">
			<tr>
				...
				<td><input onclick="search();clear_interval();" onmouseover="down(this)" onmouseout="up(this)" type="submit" id='submit' value="search" /></td>
